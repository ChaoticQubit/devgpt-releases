      ...
      _hover={
        !theme && !complete
          ? {
            ...
            bgClip: "text",
            border: "1px solid",
            borderColor: tutorial ? complete ? 'green.500' : "orange.500" : !theme ? "teal.500" : "none"
          }
          : {}
      }
      bgGradient={tutorial ? complete ? 'linear(to-r, red.400, teal.500)' : "linear(to-r, orange.400, orange.400)" : !theme ? "linear(to-r, red.500, teal.500)" : "none"}
